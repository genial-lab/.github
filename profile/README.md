...
See [dream-of-kiki/docs/ARCHITECTURE.md](https://github.com/hypneum-lab/dream-of-kiki/blob/main/docs/ARCHITECTURE.md) for the detailed cross-repo integration map.
...
See [`CONTRIBUTING.md`](https://github.com/hypneum-lab/dream-of-kiki/blob/main/CONTRIBUTING.md) in the flagship repository.
